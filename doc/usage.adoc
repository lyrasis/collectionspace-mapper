...
- authorities - *not yet implemented* - Hash - data for authority terms not found in cache or search of CollectionSpace. Structure is:
...
- vocabularies - *not yet implemented* - Hash - Data for vocabulary terms not found in cache or search of CollectionSpace. Structure is:
