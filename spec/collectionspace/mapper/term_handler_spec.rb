  ...
  describe '#result' do
    context 'titletranslationlanguage (vocabulary, field subgroup)' do
      before(:all) do
        ...
        @th = CollectionSpace::Mapper::TermHandler.new(mapping: @ttl_mapping, data: data, client: @client, cache: @cache, mapper: @handler.mapper)
      end
    ...
    context 'reference (authority, field group)' do
      before(:all) do
        ...
        @th = CollectionSpace::Mapper::TermHandler.new(mapping: @ref_mapping, data: data, client: @client, cache: @cache, mapper: @handler.mapper)
      end
      it 'result is the transformed value for mapping' do
        expected = [
  ...
  describe '#terms' do
    context 'titletranslationlanguage (vocabulary, field subgroup)' do
      before(:all) do
        ...
        @th2 = CollectionSpace::Mapper::TermHandler.new(mapping: @ttl_mapping, data: data, client: @client, cache: @cache, mapper: @handler.mapper)
      end
